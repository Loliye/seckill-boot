...
public class SeckillServiceImpl implements SeckillServiceApi {
    ...
    public OrderInfo seckill(UserVo user, GoodsVo goods) {
        ...
        log.info("SeckillServiceImpl user:{}进行秒杀 商品：{} 结果：{}",user,goods,success);
        if (!success) {
...
//    public String createVerifyCode(UserVo user, long goodsId)
//    {
//        log.info("SeckillServiceImpl 生成验证码");
//        if (user == null || goodsId <= 0)
//        {
//            return null;
//        }
...
//    {
//        //减库存
//        boolean success = goodsServie.reduceStock(goods);
//        log.info("SeckillServiceImpl user:{}进行秒杀goodsVo{} 结果：{}",user,goods,success);
//        if (!success)
//        {
//            setGoodsOver(goods.getId());
//            return null;
...
//
//        //更新缓存
//        GoodsVo goodsVo = goodsServie.getGoodsVoByGoodsId(goods.getId());
...
//    public long getSeckillResult(Long userId, long goodsId)
//    {
//        log.info("SeckillServiceImpl 获取秒杀结果");
//        SeckillOrder order = orderService.getSeckillOrderByUserIdAndGoodsId(userId, goodsId);
//
//        if (order != null)
//            return order.getOrderId();
